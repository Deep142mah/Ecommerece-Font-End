 ...
 console.log(model,"model")
  return (
    <div className="header">
      ...
      <div>
        <button className="header-button" onMouseOver={() => setToggle(true)} onMouseLeave={() => setToggle(false)} 
        onClick ={() => setModel(true) }>
          Login
        </button>
      </div>
      {toggle && (
        <div className="drop-down" onMouseOver={() => setToggle(true)} onMouseLeave={() => setToggle(false)}>
          ...
          <div className="drop-down-in2">
            <ul>
              <li className="header-li"> < CgProfile/>&nbsp;&nbsp;MyProfile</li>
              <li><TiPlusOutline/>&nbsp;&nbsp;Flipkart Zone Plus</li>
              <li>Orders</li>
              <li>Wishlist</li>
              <li>Rewards</li>
              <li>Gift Cards</li>
